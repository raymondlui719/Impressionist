...
void ImpressionistUI::cb_alphaSlides(Fl_Widget* o, void* v) {
	double alphaSliderValue = double(((Fl_Slider*)o)->value());
	((ImpressionistUI*)(o->user_data()))->m_alpha = alphaSliderValue;
}
...
ImpressionistUI::ImpressionistUI() {
	...
	m_brushDialog = new Fl_Window(400, 325, "Brush Dialog");
		...
		m_StrokeDirectionChoice->menu(strokeTypeMenu);
